...
const Skills: React.FC = () => {
    ...
    return (
        <section id="skills" className="flex flex-col text-center p-6 md:p-8 lg:p-16 min-h-[100dvh] justify-center gap-6 md:gap-8 animate-[fadeIn_0.5s_ease-out]">
            <h1 className="text-5xl font-rubik font-black tracking-normal">SKILLS</h1>
